...
// (Metadata in client files is ignored by Next at runtime, but keeping it
// here is harmless and preserves intent if you later switch back to server)
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center text-gray-600 dark:text-zinc-400">
            <p>No articles yet. You’ll see issues here as you publish them from the admin dashboard.</p>
          </div>
        </div>
      </section>
    </div>
